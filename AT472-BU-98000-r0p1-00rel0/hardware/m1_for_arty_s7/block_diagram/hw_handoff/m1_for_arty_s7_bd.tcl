...
################################################################
# This is a generated script based on design: m1_for_arty_s7
#
...
# source m1_for_arty_s7_script.tcl
...
set design_name m1_for_arty_s7
...
proc create_hier_cell_daplink_if_0 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_xip_quad_spi_0/AXI_FULL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axi_xip_quad_spi_0/AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins axi_single_spi_0/AXI_LITE]
  ...
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_single_spi_0/s_axi_aclk] [get_bd_pins axi_xip_quad_spi_0/s_axi4_aclk] [get_bd_pins axi_xip_quad_spi_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_single_spi_0/s_axi_aresetn] [get_bd_pins axi_xip_quad_spi_0/s_axi4_aresetn] [get_bd_pins axi_xip_quad_spi_0/s_axi_aresetn]
...
proc create_hier_cell_Clocks_and_Resets { parentCell nameHier } {
  ...
  create_bd_pin -dir O ext_spi_clk
  ...
  # Create instance: i_const_1, and set properties
  set i_const_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 i_const_1 ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net -net i_const_1_dout [get_bd_pins i_const_1/dout] [get_bd_pins proc_sys_reset_DAPLink/ext_reset_in]
  ...
  connect_bd_net -net reset_1 [get_bd_pins reset] [get_bd_pins proc_sys_reset_base/ext_reset_in]
  connect_bd_net -net sys_clock_1 [get_bd_pins sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net sysresetreq_1 [get_bd_pins sysresetreq] [get_bd_pins proc_sys_reset_DAPLink/mb_debug_sys_rst]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ITCM_INIT_FILE {bram_s7.hex} \
  ...
  connect_bd_intf_net -intf_net PmodHYGRO_0_Pmod_out [get_bd_intf_ports jb] [get_bd_intf_pins PmodHYGRO_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins PmodNAV_0/AXI_LITE_SPI] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins PmodNAV_0/AXI_LITE_GPIO] [get_bd_intf_pins axi_interconnect_0/M07_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins PmodHYGRO_0/AXI_LITE_TMR] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins PmodHYGRO_0/AXI_LITE_IIC] [get_bd_intf_pins axi_interconnect_0/M09_AXI]
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports qspi_flash] [get_bd_intf_pins axi_quad_spi_0/SPI_0]

  # Create port connections
  connect_bd_net -net CORTEXM1_AXI_0_SWDO [get_bd_pins CORTEXM1_AXI_0/SWDO] [get_bd_pins daplink_if_0/SWDO]
  connect_bd_net -net CORTEXM1_AXI_0_SWDOEN [get_bd_pins CORTEXM1_AXI_0/SWDOEN] [get_bd_pins daplink_if_0/SWDOEN]
  connect_bd_net -net CORTEXM1_AXI_0_SYSRESETREQ [get_bd_pins CORTEXM1_AXI_0/SYSRESETREQ] [get_bd_pins Clocks_and_Resets/sysresetreq]
  connect_bd_net -net Clocks_and_Resets_dbgresetn [get_bd_pins CORTEXM1_AXI_0/DBGRESETn] [get_bd_pins Clocks_and_Resets/dbgresetn]
  connect_bd_net -net Clocks_and_Resets_peripheral_aresetn1 [get_bd_pins Clocks_and_Resets/peripheral_aresetn1] [get_bd_pins PmodHYGRO_0/s_axi_aresetn] [get_bd_pins PmodNAV_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/M09_ARESETN]
  connect_bd_net -net Clocks_and_Resets_sysresetn [get_bd_pins CORTEXM1_AXI_0/SYSRESETn] [get_bd_pins Clocks_and_Resets/sysresetn]
  connect_bd_net -net CortexM1DbgAXI_0_TDO [get_bd_ports TDO] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net TDI_1 [get_bd_ports TDI]
  ...
  connect_bd_net -net V2C_DAPLink_interface_nSRST [get_bd_pins Clocks_and_Resets/aux_reset_in] [get_bd_pins daplink_if_0/nSRST]
  ...
  connect_bd_net -net clk_wiz_0_clk_cpu [get_bd_pins CORTEXM1_AXI_0/HCLK] [get_bd_pins Clocks_and_Resets/clk_cpu] [get_bd_pins PmodHYGRO_0/s_axi_aclk] [get_bd_pins PmodNAV_0/ext_spi_clk] [get_bd_pins PmodNAV_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins daplink_if_0/s_axi_aclk]
  connect_bd_net -net daplink_if_0_SWCLK [get_bd_pins CORTEXM1_AXI_0/SWCLKTCK] [get_bd_pins daplink_if_0/SWCLK]
  connect_bd_net -net daplink_if_0_SWDI [get_bd_pins CORTEXM1_AXI_0/SWDITMS] [get_bd_pins daplink_if_0/SWDI]
  connect_bd_net -net ext_spi_clk [get_bd_pins Clocks_and_Resets/ext_spi_clk] [get_bd_pins daplink_if_0/ext_spi_clk]
  connect_bd_net -net nTRST_1 [get_bd_ports nTRST]
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins Clocks_and_Resets/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins daplink_if_0/s_axi_aresetn]
  ...
  connect_bd_net -net reset [get_bd_ports reset] [get_bd_pins Clocks_and_Resets/reset]
  connect_bd_net -net sys_clock [get_bd_ports sys_clock] [get_bd_pins Clocks_and_Resets/sys_clock]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins CORTEXM1_AXI_0/IRQ] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins CORTEXM1_AXI_0/CFGITCMEN] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_TMR/Reg0] SEG_PmodHYGRO_0_Reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_IIC/Reg0] SEG_PmodHYGRO_0_Reg01
  create_bd_addr_seg -range 0x00010000 -offset 0x40040000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs PmodNAV_0/AXI_LITE_SPI/Reg0] SEG_PmodNAV_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40050000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs PmodNAV_0/AXI_LITE_GPIO/Reg0] SEG_PmodNAV_0_Reg01
  create_bd_addr_seg -range 0x00002000 -offset 0x60000000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0x40110000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs daplink_if_0/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg4
  create_bd_addr_seg -range 0x00010000 -offset 0x40120000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40130000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs daplink_if_0/axi_quad_spi_0/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg6
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs daplink_if_0/axi_single_spi_0/AXI_LITE/Reg] SEG_axi_single_spi_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40100000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00100000 -offset 0x00000000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs daplink_if_0/axi_xip_quad_spi_0/aximm/MEM0] SEG_axi_xip_quad_spi_0_MEM0
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces CORTEXM1_AXI_0/CM1_AXI3] [get_bd_addr_segs daplink_if_0/axi_xip_quad_spi_0/AXI_LITE/Reg] SEG_axi_xip_quad_spi_0_Reg
